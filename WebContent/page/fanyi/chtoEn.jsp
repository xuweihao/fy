...
function searchData(value,name){  
    $('#pdataList').datagrid('load', { "type": name, "chinese": value });  
...
<div>
	...
	<table id="pdataList" class="easyui-datagrid" style="width:100%;min-height:400px;"
        data-options="url:'${spath }fanyi.do/toSeachCntoEn.do',autoRowHeight:true,
        	fitColumns:false,
			singleSelect:true,
			checkOnSelect:true,
			selectOnCheck:true,
...
<form id="searchForm">
	<table>
		<tr>
			...
			<td><a href="#" class="easyui-linkbutton" onclick="delFy()" style="width:100px">删除</a> </td>
		</tr>
		<tr>
			<td colspan="3"  style="padding:10px 0px;" class="ss">
				<input id="searchBox" class="easyui-searchbox" searcher="searchData"  data-options="menu:'#mm'"  
            			prompt="请输入翻译内容" style="width:350px"/>
            </td>
